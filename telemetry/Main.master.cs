...
namespace leak_detectors
{
    public partial class Main : ULMasterPage
    {
        ...
        protected void lbPointsAdd_Click(object sender, EventArgs e)
        {
        ...
        private void LoadMenu()
        {
            ...
            menu.Add("<li style=\"\"><a href=\"Equipment.aspx\"><span style=\"\">Общая информация о состоянии оборудовании на точках</span></a></li>");
            menu.Add("<li style=\"\"><a href=\"AddPoints.aspx\"><span style=\"\">Добавление точки</span></a></li>");
            menu.Add("<li style=\"\"><a href=\"EquipRegistration.aspx\"><span style=\"\">Справочник оборудования</span></a></li>");
            menu.Add("<li style=\"\"><a href=\"DirectType.aspx\"><span style=\"\">Тип оборудования</span></a></li>");
