<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="SJournal.aspx.cs" Inherits="leak_detectors.SJournal"%>
<%@ Register src="../Controls/AlternAbonDet.ascx" tagName="AlternAbonDet" tagPrefix="uc1"%>
<%@ Register TagPrefix="uc1" Namespace="leak_detectors.Controls" Assembly="leak_detectors" %>
