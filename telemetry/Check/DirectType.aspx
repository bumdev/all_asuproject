<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="DirectType.aspx.cs" Inherits="leak_detectors.DirectType" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel runat="server" ID="up1">
<ContentTemplate>
<div style="width:100%; float:inherit; text-align:center;"><span style="font-weight:bold; font-size:18px; ">Тип оборудования</span></div>
<asp:TextBox runat="server" ID="tbTypeName" Width="400px"  Visible="true"></asp:TextBox>
	...
	<Columns>
        <asp:TemplateField Visible="true" AccessibleHeaderText="colEdit"  HeaderStyle-Width="175px">
            <ItemTemplate>
                ...
                <asp:LinkButton ID="LinkButton1" CommandName="Delete" CssClass="FormButton" runat="server"  OnClientClick=<%# "return confirm('Вы действительно хотите удалить тип оборудования?');" %> ><span>Удалить</span></asp:LinkButton>
		    </ItemTemplate>
		    <EditItemTemplate>
        ...
        <asp:BoundField HeaderText="Тип оборудования" ControlStyle-Width="400px" DataField="TypeName" SortExpression="seller"/>
	</Columns>
</cuc:GridView>
...
UpdateCommand="UpdateTypeEquipment" UpdateCommandType="StoredProcedure"
DeleteCommand="DeleteTypeEquipment" DeleteCommandType="StoredProcedure"
InsertCommand="CreateTypeEquipment" InsertCommandType="StoredProcedure">
    <UpdateParameters>
