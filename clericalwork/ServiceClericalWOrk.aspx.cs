...
{
    public partial class ServiceClericalWork : ULPage
    {
        ...
        protected void radgrid_InsertCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.Item.OwnerTableView.Name == "ServiceClericalWork")
            {
                Entities.User u = GetCurrentUser();

                dsJournal.InsertParameters.Add(new Parameter("ServiceName", DbType.String, (insertedItem["ServiceName"].Controls[0] as TextBox).Text));
        ...
        protected void radgridServices_UpdateCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.Item.OwnerTableView.Name == "ServiceClericalWork")
            {
                ...
                dsJournal.UpdateParameters.Add(new Parameter("ServiceName", DbType.String,(updatedItem["ServiceName"].Controls[0] as TextBox).Text));
