...
{
    public partial class QuestionType : ULPage
    {
        ...
        protected void radgrid_InsertCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.Item.OwnerTableView.Name == "TypeQuestion")
            {
                Entities.User u = GetCurrentUser();

                dsJournal.InsertParameters.Add(new Parameter("NameQuestion", DbType.String, (insertedItem["NameQuestion"].Controls[0] as TextBox).Text));
        ...
        protected void radgridServices_UpdateCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.Item.OwnerTableView.Name == "TypeQuestion")
            {
                ...
                dsJournal.UpdateParameters.Add(new Parameter("NameQuestion", DbType.String, (updatedItem["NameQuestion"].Controls[0] as TextBox).Text));
