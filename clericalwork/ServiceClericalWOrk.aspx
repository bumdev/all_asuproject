<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="ServiceClericalWork.aspx.cs" Inherits="ClericalWork_WebApp.ServiceClericalWork" %>
...
<div>
  ...
  <telerik:RadGrid runat="server" ID="radgrid" AutoGenerateColumns="false"   PageSize="10"
    ...
    <Pdf DefaultFontFamily="Arial Unicode MS" PageTopMargin="2" PageLeftMargin="2" PageRightMargin="2" PageBottomMargin="2"/>
        ...
        <MasterTableView IsFilterItemExpanded="True" EditFormSettings-PopUpSettings-Width="900px" DataKeyNames="ID" Width="100%" CommandItemDisplay="Top" AllowAutomaticUpdates="true" Name="ServiceClericalWork"  AllowFilteringByColumn="true" >
            ...
            <Columns>
                ...
                <%--<telerik:GridBoundColumn FilterControlWidth="40px" ItemStyle-Width="50px" AutoPostBackOnFilter="false" CurrentFilterFunction="EqualTo" FilterDelay="2000" ShowFilterIcon="false" DataField="ID" HeaderText="ID"  UniqueName="serv_id" ></telerik:GridBoundColumn>--%>
                <telerik:GridBoundColumn DataField="ServiceName" HeaderText="Название службы" SortExpression="ServiceName" ShowFilterIcon="false" FilterDelay="2000" FilterControlWidth="200" CurrentFilterFunction="Contains" AutoPostBackOnFilter="false"></telerik:GridBoundColumn>
...
<asp:SqlDataSource ID="dsJournal" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionInfo %>" 
    ...
    InsertCommand="CreateServiceCler" InsertCommandType="StoredProcedure"
    UpdateCommand="UpdateServiceCler" UpdateCommandType="StoredProcedure"
    DeleteCommand="DeleteServiceCler" DeleteCommandType="StoredProcedure">
</asp:SqlDataSource>
</div>
</ContentTemplate>
</asp:UpdatePanel>
