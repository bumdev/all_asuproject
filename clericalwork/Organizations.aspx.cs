...
{
    public partial class Organizations : ULPage
    {
        ...
        protected void radgrid_InsertCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.Item.OwnerTableView.Name == "Organ")
            {
                Entities.User u = GetCurrentUser();

                dsJournal.InsertParameters.Add(new Parameter("NameOrganization", DbType.String, (insertedItem["NameOrganization"].Controls[0] as TextBox).Text));
        ...
        protected void radgridServices_UpdateCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.Item.OwnerTableView.Name == "Organ")
            {
                ...
                dsJournal.UpdateParameters.Add(new Parameter("NameOrganization", DbType.String, (updatedItem["NameOrganization"].Controls[0] as TextBox).Text));
