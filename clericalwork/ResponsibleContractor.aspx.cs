...
{
    public partial class ResponsibleContractor : ULPage
    {
        ...
        protected void radgrid_InsertCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.Item.OwnerTableView.Name == "ResponContract")
            {
                Entities.User u = GetCurrentUser();

                dsJournal.InsertParameters.Add(new Parameter("NameResponsibleContractor", DbType.String, (insertedItem["NameResponsibleContractor"].Controls[0] as TextBox).Text));
        ...
        protected void radgridServices_UpdateCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.Item.OwnerTableView.Name == "ResponContract")
            {
                ...
                dsJournal.UpdateParameters.Add(new Parameter("NameResponsibleContractor", DbType.String, (updatedItem["NameResponsibleContractor"].Controls[0] as TextBox).Text));
