<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="TypeMail.aspx.cs" Inherits="ClericalWork_WebApp.TypeMail" %>
...
<div>
  ...
  <telerik:RadGrid runat="server" ID="radgrid" AutoGenerateColumns="false"   PageSize="10"
    ...
    <Pdf DefaultFontFamily="Arial Unicode MS" PageTopMargin="2" PageLeftMargin="2" PageRightMargin="2" PageBottomMargin="2"/>
        ...
        <MasterTableView IsFilterItemExpanded="True" EditFormSettings-PopUpSettings-Width="900px" DataKeyNames="ID" Width="100%" CommandItemDisplay="Top" AllowAutomaticUpdates="true" Name="TypeMail"  AllowFilteringByColumn="true" >
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="TypeName" HeaderText="Тип почты" SortExpression="TypeName" ShowFilterIcon="false" FilterDelay="2000" FilterControlWidth="200" CurrentFilterFunction="Contains" AutoPostBackOnFilter="false"></telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="Comment" HeaderText="Примечание" SortExpression="Comment" ShowFilterIcon="false" FilterDelay="2000" FilterControlWidth="200" CurrentFilterFunction="Contains" AutoPostBackOnFilter="false"></telerik:GridBoundColumn>
...
<asp:SqlDataSource ID="dsJournal" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionInfo %>" 
    SelectCommand="RetrieveTypeMail" SelectCommandType="StoredProcedure" 
    InsertCommand="CreateTypeMail" InsertCommandType="StoredProcedure"
    UpdateCommand="UpdateTypeMail" UpdateCommandType="StoredProcedure"
    DeleteCommand="DeleteTypeMail" DeleteCommandType="StoredProcedure">
</asp:SqlDataSource>
</div>
</ContentTemplate>
</asp:UpdatePanel>
