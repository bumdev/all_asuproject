...
{
    public partial class TypeMail : ULPage
    {
        ...
        protected void radgrid_InsertCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.Item.OwnerTableView.Name == "TypeMail")
            {
                Entities.User u = GetCurrentUser();

                dsJournal.InsertParameters.Add(new Parameter("TypeName", DbType.String, (insertedItem["TypeName"].Controls[0] as TextBox).Text));
        ...
        protected void radgridServices_UpdateCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.Item.OwnerTableView.Name == "TypeMail")
            {
                ...
                dsJournal.UpdateParameters.Add(new Parameter("TypeName", DbType.String, (updatedItem["TypeName"].Controls[0] as TextBox).Text));
