<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="CategoryComplaints.aspx.cs" Inherits="ClericalWork_WebApp.CategoryComplaints" %>
...
<div>
  ...
  <telerik:RadGrid runat="server" ID="radgrid" AutoGenerateColumns="false"   PageSize="10"
    ...
    <Pdf DefaultFontFamily="Arial Unicode MS" PageTopMargin="2" PageLeftMargin="2" PageRightMargin="2" PageBottomMargin="2"/>
        ...
        <MasterTableView IsFilterItemExpanded="True" EditFormSettings-PopUpSettings-Width="900px" DataKeyNames="ID" Width="100%" CommandItemDisplay="Top" AllowAutomaticUpdates="true" Name="Category"  AllowFilteringByColumn="true" >
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="NameCategory" HeaderText="Категория жалобы" SortExpression="NameCategory" ShowFilterIcon="false" FilterDelay="2000" FilterControlWidth="200" CurrentFilterFunction="Contains" AutoPostBackOnFilter="false"></telerik:GridBoundColumn>
...
<asp:SqlDataSource ID="dsJournal" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionInfo %>" 
    SelectCommand="RetrieveCategoryComp" SelectCommandType="StoredProcedure" 
    InsertCommand="CreateCategoryComp" InsertCommandType="StoredProcedure"
    UpdateCommand="UpdateCategoryComp" UpdateCommandType="StoredProcedure"
    DeleteCommand="DeleteCategoryComp" DeleteCommandType="StoredProcedure">
</asp:SqlDataSource>
</div>
</ContentTemplate>
</asp:UpdatePanel>
