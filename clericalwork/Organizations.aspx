<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="Organizations.aspx.cs" Inherits="ClericalWork_WebApp.Organizations" %>
...
<div>
  ...
  <telerik:RadGrid runat="server" ID="radgrid" AutoGenerateColumns="false"   PageSize="10"
    ...
    <Pdf DefaultFontFamily="Arial Unicode MS" PageTopMargin="2" PageLeftMargin="2" PageRightMargin="2" PageBottomMargin="2"/>
        ...
        <MasterTableView IsFilterItemExpanded="True" EditFormSettings-PopUpSettings-Width="900px" DataKeyNames="ID" Width="100%" CommandItemDisplay="Top" AllowAutomaticUpdates="true" Name="Organ"  AllowFilteringByColumn="true" >
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="NameOrganization" HeaderText="Организация" SortExpression="NameOrganization" ShowFilterIcon="false" FilterDelay="2000" FilterControlWidth="200" CurrentFilterFunction="Contains" AutoPostBackOnFilter="false"></telerik:GridBoundColumn>
...
<asp:SqlDataSource ID="dsJournal" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionInfo %>" 
    SelectCommand="RetrieveOrganizations" SelectCommandType="StoredProcedure" 
    InsertCommand="CreateOrganizations" InsertCommandType="StoredProcedure"
    UpdateCommand="UpdateOrganizations" UpdateCommandType="StoredProcedure"
    DeleteCommand="DeleteOrganizations" DeleteCommandType="StoredProcedure">
</asp:SqlDataSource>
</div>
</ContentTemplate>
</asp:UpdatePanel>
