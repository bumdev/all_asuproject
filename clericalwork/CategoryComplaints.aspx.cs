...
{
    public partial class CategoryComplaints : ULPage
    {
        ...
        protected void radgrid_InsertCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.Item.OwnerTableView.Name == "Category")
            {
                Entities.User u = GetCurrentUser();

                dsJournal.InsertParameters.Add(new Parameter("NameCategory", DbType.String, (insertedItem["NameCategory"].Controls[0] as TextBox).Text));
        ...
        protected void radgridServices_UpdateCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.Item.OwnerTableView.Name == "Category")
            {
                ...
                dsJournal.UpdateParameters.Add(new Parameter("NameCategory", DbType.String, (updatedItem["NameCategory"].Controls[0] as TextBox).Text));
