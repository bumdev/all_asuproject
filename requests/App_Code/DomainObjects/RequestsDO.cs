...
namespace DomainObjects
{
    public class RequestsDO:UniversalDO
    {
        ...
        public bool RemoveToArchive(int requestsID, int UserID)
        {
            bool success = true;
            RequestsDAO entDAO = new RequestsDAO();
            sc = new SqlCommand("RemoveToArchive");
            sc.CommandType = CommandType.StoredProcedure;
            sc.Parameters.Add("@RequestsID", requestsID);
            sc.Parameters.Add("@UserID", UserID);
            success = entDAO.updateEntity(sc);
        ...
        public bool ReestablishToRemove(int requestsID, int UserID)
        {
            bool success = true;
            RequestsDAO entDAO = new RequestsDAO();
            sc = new SqlCommand("ReestablishToRemove");
            sc.CommandType = CommandType.StoredProcedure;
            sc.Parameters.Add("@RequestsID", requestsID);
            sc.Parameters.Add("@UserID", UserID);
            success = entDAO.updateEntity(sc);
