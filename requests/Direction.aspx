<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Direction.aspx.cs" Inherits="requests_app.Direction" %>
...
<body>
    ...
    <div style="width:720px; height:20px; border:0px solid red; margin-bottom:10px; color:black; text-align:right; font-size:16px; font-weight:bold;">Добро пожаловать&nbsp;<asp:Literal runat="server" ID="litUserName"></asp:Literal></div>
    <a href="Check/RemoveJournal.aspx">
        ...
        <span style="font-size:16px;position:absolute; font-family:Verdana; margin-left:90px; margin-top:250px;">Заявки</span>
        
        <div style="width:128px; height:128px; background-image:url('Images/check-mark (1).png'); margin-left:55px;margin-top:45px; border:0px solid black;"></div>
        </div>
        </a>
        ...
        <div style="width:128px; height:128px; background-image:url('Images/settings.png');margin-left:50px;margin-top:45px;"></div>
        </div>
        </a>
        ...
        <div style="width:128px; height:128px; background-image:url('Images/door (2).png');margin-left:55px;margin-top:55px;"></div>
        </div>
        </a>
        <!--
