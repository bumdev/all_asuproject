<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="SJournal.aspx.cs" Inherits="requests_app.SJournal"%>
<%@ Register src="../Controls/AlternAbonDet.ascx" tagName="AlternAbonDet" tagPrefix="uc1"%>
<%@ Register TagPrefix="uc1" Namespace="requests_app.Controls" Assembly="requests_app" %>
