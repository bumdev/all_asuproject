<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ArchiveDet.ascx.cs" Inherits="requests_app.Controls.ArchiveDet" %>
...
<telerik:RadAjaxPanel runat="server" ID="up">
    ...
    <asp:Panel runat="server" ID="ArchiveForm" Width="1500px" Height="500px">
                ...
                <asp:Panel runat="server" ID="punRequestsEditor" Visible="false">
                   ...
                   <div class="FormItem">
                        ...
                        <div>
                            ...
                            <telerik:RadButton runat="server" Text="Отказались" ID="radbutAnnulmentRequests" OnClick="radbutAnnulmentRequests_OnClick"></telerik:RadButton>
                            ...
                            <telerik:RadButton runat="server" Text="Не установлен" ID="radbutbackToRemove" OnClick="radbutBackToRemove_OnClick"></telerik:RadButton>
                            <div style="margin-top: 5px">
                                <telerik:RadButton runat="server" Text="Восстановить в снятие" ID="radbutReestablishToRemove" OnClick="radbutReestablishToRemove_OnClick"></telerik:RadButton>
                            </div>
