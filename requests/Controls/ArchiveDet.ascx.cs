...
{
    public partial class ArchiveDet : ULControl
    {
        ...
        protected void radbutAnnulmentRequests_OnClick(object sender, EventArgs e)
        {
            RequestsDO fado = new RequestsDO();
            fado.Annulment(Utilities.ConvertToInt(hfODID.Value), GetCurrentUser().ID);
            _OrderID = Utilities.ConvertToInt(hfODID.Value);
            Bind();
        }

        protected void radbutSubstitutionRemove_OnClick(object sender, EventArgs e)
        {
            RequestsDO fado = new RequestsDO();
            fado.SubstitutionRemove(Utilities.ConvertToInt(hfODID.Value), GetCurrentUser().ID);
            _OrderID = Utilities.ConvertToInt(hfODID.Value);
            Bind();
        }
        ...
        protected void radbutReestablishToRemove_OnClick(object sender, EventArgs e)
        {
            RequestsDO fado = new RequestsDO();
            fado.ReestablishToRemove(Utilities.ConvertToInt(hfODID.Value), GetCurrentUser().ID);
            _OrderID = Utilities.ConvertToInt(hfODID.Value);
            Bind();
        }
