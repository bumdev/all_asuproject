<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="MailOutJournal.aspx.cs" Inherits="outcomming_mail.MailOutJournal"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="radgrid">
             ...
             <telerik:AjaxSetting AjaxControlID="MailOutDet1">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="MailOutDet1" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
   ...
   <script type="text/javascript">
       function RowSelected(sender, args) {
           ...
           var oWnd = radopen("MailOutcommingDet.aspx?id=" + args.getDataKeyValue("ID"), null, 800, 700, 20, 20);
           oWnd.set_visibleStatusbar = false;
           oWnd.center();
       }
    </script>
     <telerik:RadWindow runat="server" ID="radMailOut" Title="Просмотр исходящей почты"  Width="720px" MinHeight="430px" CenterIfModal="True" KeepInScreenBounds="True" VisibleStatusbar="False">
            <ContentTemplate>
    ...
    <telerik:RadGrid runat="server" ID="radgrid" AutoGenerateColumns="false" 
        CssClass="rad" 
        AllowPaging="True"  Font-Names="Arial Unicode MS" PageSize="25"  DataSourceID="dsMailOutJournal">
         <GroupingSettings CaseSensitive="false"></GroupingSettings>
        <ClientSettings>
            <Selecting AllowRowSelect="true" />
            <ClientEvents OnRowSelected="RowSelected" />
        </ClientSettings>
     <MasterTableView DataKeyNames="ID"  Width="100%"  Name="Order"  AllowFilteringByColumn="true"  ClientDataKeyNames="ID" DataSourceID="dsMailOutJournal">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="PersonalAccount" HeaderText="Лицевой счет" AutoPostBackOnFilter="true" FilterDelay="2000" CurrentFilterFunction="Contains" ShowFilterIcon="false"></telerik:GridBoundColumn>
                ...
                <telerik:GridBoundColumn DataField="AdresatType" HeaderText="В чьем лице" AutoPostBackOnFilter="true" FilterDelay="2000" CurrentFilterFunction="Contains" ShowFilterIcon="false"></telerik:GridBoundColumn>
                ...
                <telerik:GridDateTimeColumn FilterControlWidth="45px" DataType="System.DateTime" DataField="AnswerDate" EnableTimeIndependentFiltering="true" EnableRangeFiltering="true" UniqueName="AnswerDate" HeaderText="Дата ответа" PickerType="DatePicker" DataFormatString="{0:dd/MM/yyyy}">
                    <ItemStyle Width="100px"></ItemStyle>
                </telerik:GridDateTimeColumn>
        </Columns>
        </MasterTableView>
</telerik:RadGrid>
    <asp:SqlDataSource ID="dsMailOutJournal" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionInfo %>" 
        SelectCommand="RetrieveOutMailJournal" SelectCommandType="StoredProcedure">
        <SelectParameters>
