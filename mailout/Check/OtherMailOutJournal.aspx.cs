...
{
    public partial class OtherMailOutJournal : ULPage
    {
        ...
        protected void radgridDevice_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            {
                radgrid.DataSource = (DataView)dsOtherMailOutJournal.Select(DataSourceSelectArguments.Empty);
            }
        }
        ...
        protected void radGridDevice_ItemCommand(object sender, GridCommandEventArgs e)
        {
            if (e.CommandName == "ShowMail")
            {
                ...
                OtherMailOutDet1.SendID = Utilities.ConvertToInt(itemValue);
