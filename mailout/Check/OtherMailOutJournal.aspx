<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="OtherMailOutJournal.aspx.cs" Inherits="outcomming_mail.OtherMailOutJournal"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="radgrid">
             ...
             <telerik:AjaxSetting AjaxControlID="OtherMailOutDet1">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="OtherMailOutDet1" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
   ...
   <script type="text/javascript">
       function RowSelected(sender, args) {
           ...
           var oWnd = radopen("OtherMailOutcommingDet.aspx?id=" + args.getDataKeyValue("ID"), null, 800, 700, 20, 20);
           oWnd.set_visibleStatusbar = false;
           oWnd.center();
       }
    </script>
     <telerik:RadWindow runat="server" ID="radOtherMailOut" Title="Просмотр исходящей почты"  Width="720px" MinHeight="430px" CenterIfModal="True" KeepInScreenBounds="True" VisibleStatusbar="False">
            <ContentTemplate>
    ...
    <telerik:RadGrid runat="server" ID="radgrid" AutoGenerateColumns="false" 
        CssClass="rad" 
        AllowPaging="True"  Font-Names="Arial Unicode MS" PageSize="25"  DataSourceID="dsOtherMailOutJournal">
         <GroupingSettings CaseSensitive="false"></GroupingSettings>
        <ClientSettings>
            <Selecting AllowRowSelect="true" />
            <ClientEvents OnRowSelected="RowSelected" />
        </ClientSettings>
     <MasterTableView DataKeyNames="ID"  Width="100%"  Name="Order"  AllowFilteringByColumn="true"  ClientDataKeyNames="ID" DataSourceID="dsOtherMailOutJournal">
            <Columns>
    ...
    <asp:SqlDataSource ID="dsOtherMailOutJournal" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionInfo %>" 
        SelectCommand="RetrieveOtherOutMailJournal" SelectCommandType="StoredProcedure">
        <SelectParameters>
