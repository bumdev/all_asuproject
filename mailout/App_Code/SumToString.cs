    ...
    static string[] monthNamesGenitive =
{
    ...
    static string[] monthNamesGenitiveUA =
{
    ...
    static string[] copecks =
{
    ...
    /// <param name="_date"></param>
    /// <returns></returns>
    public static string DateToTextLongUA(DateTime _date)
    {
        return String.Format("«{0}» {1} {2}",
                                _date.Day.ToString("D2"),
                                MonthNameUA(_date.Month, TextCase.Genitive),
                                _date.Year.ToString());
    }
    ...
    static bool FistRubSum(int _digits)
    {
        if (_digits >= 2)
            return true;
    ...
    static bool FinalRubSum(int _digits)
    {
        if (_digits >= 5)
            return true;
    ...
    public static string CurrencyToTxt(double _amount, bool _firstCapital)
    {
        ...
        string s = NumeralsToTxt(rublesAmount, TextCase.Nominative, false, _firstCapital) + " ";
    ...
    /// <param name="_firstCapital"></param>
    /// <returns></returns>
    public static string CurrencyToTxtRub(double _amount, bool _firstCapital)
    {
        //Десять тысяч рублей 67 копеек
        long rublesAmount = (long)Math.Floor(_amount);
        long copecksAmount = ((long)Math.Round(_amount * 100)) % 100;
        ...
        if (FinalRubSum(lastRublesDigit))
        {
            s += rubmoney[3] + " ";
        }
        else if (FistRubSum(lastRublesDigit))
        {
            s += rubmoney[2] + " ";
        }
        else
    ...
    public static string MonthNameUA(int _month, TextCase _case)
    {
        string s = "";
...
public static class UADateAndMoneyConverter
{
    ...
    static string[] monthNamesGenitive =
{
    ...
    static string firstMaleGenetive = "одно";
    static string secondMale = "два";
    static string secondFemale = "двi";
    static string secondMaleGenetive = "двух";
    static string secondFemaleGenetive = "двух";
    ...
    static string[] from3till19Genetive = 
{
    "", "трьох", "чотирьох", "п'яти", "шести",
     "семи", "Вісім", "дев'яти", "десяти", "одинадцяти",
    ...
    static string[] hundredsGenetive =
{
    "", "ста", "двохсот", "трьохсот", "чотирьохсот",
     "п'ятисот", "шестисот", "семисот", "восемісот", "дев'ятисот"
};
    static string[] thousands =
{
    "", "тисяча", "тисячі", "тисяч"
