...
namespace DomainObjects
{
    public class CustomRetrieverDO : UniversalDO
    {
        ...
        public UniversalEntity RetrieveResponContractDeprtament()
        {
            sc = new SqlCommand("RetrieveResponContractDepartament");
            sc.CommandType = CommandType.StoredProcedure;
            CustomRetrieverDAO cDAO = new CustomRetrieverDAO();
            return cDAO.RetrieveResponContractDepartament(sc);
        }
        ...
        public UniversalEntity RetrieveSender()
        {
            sc = new SqlCommand("RetrieveSender");
            sc.CommandType = CommandType.StoredProcedure;
            CustomRetrieverDAO cDAO = new CustomRetrieverDAO();
            return cDAO.RetrieveSender(sc);
        }

        public UniversalEntity RetrieveAdresatType()
        {
            sc = new SqlCommand("RetrieveAdresatType");
            sc.CommandType = CommandType.StoredProcedure;
            CustomRetrieverDAO cDAO = new CustomRetrieverDAO();
            return cDAO.RetrieveAdresatType(sc);
        }

        public UniversalEntity RetrievePhysicalAdresatType()
        {
            sc = new SqlCommand("RetrievePhysicalAdresat");
            sc.CommandType = CommandType.StoredProcedure;
            CustomRetrieverDAO cDAO = new CustomRetrieverDAO();
            return cDAO.RetrievePhysicalAdresatType(sc);
        }
