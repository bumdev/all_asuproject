<%@ Page Title="Контроль служб (уволенные)" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="FiredControl.aspx.cs" Inherits="Timetable_WebApp.FiredControl" %>
...
<div>
  ...
  <telerik:RadGrid runat="server" ID="radgrid" AutoGenerateColumns="false"   PageSize="10"
    ...
    <Pdf DefaultFontFamily="Arial Unicode MS" PageTopMargin="2" PageLeftMargin="2" PageRightMargin="2" PageBottomMargin="2"/>
        ...
        <MasterTableView EditMode="PopUp" EditFormSettings-PopUpSettings-Width="600px" TableLayout="fixed" DataKeyNames="ID" DataMember="WP" Width="100%" CommandItemDisplay="Top" AllowAutomaticUpdates="true" Name="FiredServiceAccept"  AllowFilteringByColumn="true" >
    ...
    <div id="FormItem">
        <div class="label" style="padding: 20px; width: 47%">Загрузить документы</div>
...
SelectCommand="RetrieveFiredServiceAccept" SelectCommandType="StoredProcedure" >
</asp:SqlDataSource>
</div>
</ContentTemplate>
</asp:UpdatePanel>
