...
{
    public partial class CommonJournal : ULPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                /*if (Request["id"] != null)
                {
                    ...
                    window1.NavigateUrl = "check/CommonDeviceDet.aspx?id=" + Request["id"];// "FabonentDet.aspx?id=" + Request["id"];
        ...
        protected void radgridDevice_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            {
                radgrid.DataSource = (DataView)dsCommonJournal.Select(DataSourceSelectArguments.Empty);
            }
        }
        /*protected void radgridDevice_ItemCommand(object sender, GridCommandEventArgs e)
        {
            if (e.CommandName == "Requests")
            {
                if (e.Item is GridDataItem)
                {
                    ...
                    CommonDet1.OrderID = Utilities.ConvertToInt(itemValue);  // Convert.ToInt32(e.Item.OwnerTableView.Items[e.]);
                    CommonDet1.Bind();
                }
            }
        }*/
