<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="SJournal.aspx.cs" Inherits="cartridges_app.SJournal"%>
<%@ Register src="../Controls/AlternAbonDet.ascx" tagName="AlternAbonDet" tagPrefix="uc1"%>
<%@ Register TagPrefix="uc1" Namespace="cartridges_app.Controls" Assembly="cartridges_app" %>
