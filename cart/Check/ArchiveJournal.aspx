<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" Inherits="cartridges_app.ArchiveJournal" Codebehind="ArchiveJournal.aspx.cs"  %>
    ...
    <telerik:RadGrid runat="server" ID="radgrid" AutoGenerateColumns="false" 
     ...
     <MasterTableView DataKeyNames="ID" DataMember="Forder" Width="100%"  Name="Order"  AllowFilteringByColumn="true"  ClientDataKeyNames="ID">
            ...
            <Columns>
                ...
                <telerik:GridDateTimeColumn FilterControlWidth="60px" DataField="DateArchiveation" EnableTimeIndependentFiltering="True" EnableRangeFiltering="true" UniqueName="DateArchiveation" HeaderText="Дата установки" PickerType="DatePicker" DataFormatString="{0:dd/MM/yyyy}">
                    <ItemStyle Width="100px"></ItemStyle>
                </telerik:GridDateTimeColumn>
                <telerik:GridBoundColumn FilterControlWidth="50px" DataField="Comment" HeaderText="Примечание"></telerik:GridBoundColumn>
                 <telerik:GridCheckBoxColumn DataField="IsAnnulment" HeaderText="Отказано" />
                <telerik:GridCheckBoxColumn DataField="IsSubstitution" HeaderText="Замена" />
                <telerik:GridCheckBoxColumn DataField="IsDone" HeaderText="Выполнено" />
                <telerik:GridCheckBoxColumn DataField="IsInstallation" HeaderText="Установлен" />
