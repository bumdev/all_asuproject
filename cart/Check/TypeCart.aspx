<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="TypeCart.aspx.cs" Inherits="cartridges_app.TypeCart" %>
...
<asp:TextBox runat="server" ID="tbNameCartridge" Width="400px"  Visible="True"></asp:TextBox>
	...
	<Columns>
        <asp:TemplateField Visible="True" AccessibleHeaderText="colEdit"  HeaderStyle-Width="175px">
            <ItemTemplate>
                ...
                <asp:LinkButton ID="LinkButton1" CommandName="Delete" CssClass="FormButton" runat="server"  OnClientClick=<%# "return confirm('Вы действительно хотите удалить модель картриджа?');" %> ><span>Удалить</span></asp:LinkButton>
		    </ItemTemplate>
		    <EditItemTemplate>
        ...
        <asp:BoundField HeaderText="Название" ControlStyle-Width="400px" DataField="NameCartridge" SortExpression="NameCartridge"/>
	</Columns>
</cuc:GridView>
<asp:SqlDataSource ID="dsJournal" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionInfo %>" 
SelectCommand="RetrieveTypeCart" SelectCommandType="StoredProcedure" 
UpdateCommand="UpdateTypeCart" UpdateCommandType="StoredProcedure"
DeleteCommand="DeleteTypeCart" DeleteCommandType="StoredProcedure"
InsertCommand="CreateTypeCart" InsertCommandType="StoredProcedure">
    <UpdateParameters>
        <asp:Parameter Name="ID" Type="Int32" />
        <asp:Parameter Name="NameCartridge" Type="String" />
    </UpdateParameters>
    <DeleteParameters>
	    <asp:Parameter Name="ID" Type="Int32" />
	</DeleteParameters>
