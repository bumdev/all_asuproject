<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="AddAbonent.aspx.cs" Inherits="cartridges_app.AddAbonent" %>
 ...
 <asp:Panel runat="server" ID="Step1">
        ...
        <asp:Panel runat="server" ID="panPerson" Visible="false">
            ...
            <div class="FormItem">
                ...
                <ajaxToolkit:TextBoxWatermarkExtender runat="server" ID="TextBoxWatermarkExtender13" TargetControlID="tbNumberJournal" WatermarkCssClass="WaterText" WatermarkText="34562"></ajaxToolkit:TextBoxWatermarkExtender>
                <div><asp:TextBox runat="server" ID="tbNumberJournal" Width="200px"></asp:TextBox></div>
                <div style="clear: both;"></div>
            </div>
            <div class="FormItem">
          ...
          <div style="clear:both;"></div>
           ...
           <asp:Repeater runat="server" ID="repCorporate" 
            ...
            <asp:DataGrid runat="server" ID="dgCorporate"></asp:DataGrid>
               ...
               <div class="FormItem">Добавление иногороднего юр. абонента</div>
            <div class="FormItem">
                <div class="label">Номер по журналу:</div>
                <ajaxToolkit:TextBoxWatermarkExtender runat="server" ID="TextBoxWatermarkExtender20" TargetControlID="tbCorporateNumberJournal" WatermarkText="123" WatermarkCssClass="WaterText"></ajaxToolkit:TextBoxWatermarkExtender>
                <div><asp:TextBox runat="server" ID="tbCorporateNumberJournal" Width="200px"></asp:TextBox></div>
                <div style="clear: both;"></div>
            </div>
            <div class="FormItem">
                <div class="label">Абонент:</div>
                <ajaxToolkit:TextBoxWatermarkExtender runat="server" ID="TextBoxWatermarkExtender8" TargetControlID="tbClientTitle" WatermarkText="ООО Водоканал" WatermarkCssClass="WaterText"></ajaxToolkit:TextBoxWatermarkExtender>
                <div><asp:TextBox runat="server" ID="tbClientTitle" Width="200px"></asp:TextBox></div>
                <div style="clear:both;"></div>
            </div>
            <div class="FormItem">
                <div class="label">ОКПО:</div>
                <ajaxToolkit:TextBoxWatermarkExtender runat="server" ID="TextBoxWatermarkExtender9" TargetControlID="tbClientOKPO" WatermarkText="0123456789" WatermarkCssClass="WaterText"></ajaxToolkit:TextBoxWatermarkExtender>
                <div><asp:TextBox runat="server" ID="tbClientOKPO" Width="200px"></asp:TextBox></div>
                <div style="clear:both;"></div>
            </div>
            <div class="FormItem">
                <div class="label">Расчетный счет:</div>
                <ajaxToolkit:TextBoxWatermarkExtender runat="server" ID="TextBoxWatermarkExtender10" TargetControlID="tbClientRS" WatermarkText="200000000963" WatermarkCssClass="WaterText"></ajaxToolkit:TextBoxWatermarkExtender>
                <div><asp:TextBox runat="server" ID="tbClientRS" Width="200px"></asp:TextBox></div>
                <div style="clear:both;"></div>
            </div>
            <div class="FormItem">
                <div class="label">Телефон:</div>
                <ajaxToolkit:TextBoxWatermarkExtender runat="server" ID="TextBoxWatermarkExtender11" TargetControlID="tbClientPhone" WatermarkText="+380 50 111 11 11" WatermarkCssClass="WaterText"></ajaxToolkit:TextBoxWatermarkExtender>
                <div><asp:TextBox runat="server" ID="tbClientPhone" Width="200px"></asp:TextBox></div>
                <div style="clear:both;"></div>
            </div>
            <div class="FormItem">
                <div class="label">Адрес:</div>

                <ajaxToolkit:TextBoxWatermarkExtender runat="server" ID="TextBoxWatermarkExtender12" TargetControlID="asd" WatermarkText="Артема 942" WatermarkCssClass="WaterText"></ajaxToolkit:TextBoxWatermarkExtender>
                <div><asp:TextBox runat="server" ID="TextBox1" Width="200px" Visible="False"></asp:TextBox>
                    
                      <telerik:RadAutoCompleteBox ID="tbAddressUA" runat="server" Width="200" DropDownWidth="200"
                DropDownHeight="200" DataSourceID="SqlDataSource1" DataTextField="Name" Filter="StartsWith" InputType="Text" AllowCustomEntry="True"  Delimiter=" "
                DataValueField="Name">
                          <TextSettings SelectionMode="Single"></TextSettings>
            </telerik:RadAutoCompleteBox>
                    
                     <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString="<%$ ConnectionStrings:ConnectionInfoDB4 %>"
        ProviderName="System.Data.SqlClient" SelectCommand="SELECT name FROM Streets ORDER By name asc ">
    </asp:SqlDataSource>
               ...
               <div class="FormItem">
                   <asp:LinkButton runat="server" ID="repCorporateAbonent" CssClass="FormButton" OnClick="repCorporateAbonent_Click">
                       <span>Далее</span>
                   </asp:LinkButton>
               </div></div>
     ...
     <asp:Panel runat="server" ID="panSpecial" Visible="false">
           <div class="FormItem">
               <div class="label">Район:</div>
               <div><asp:DropDownList runat="server" runat="server" ID="ddDistrictWithdrawal" Width="200px"></asp:DropDownList></div>
               <div style="clear:both;"></div>
           </div>
         <div class="FormItem">
             <div class="label">Номер по журналу:</div>
             <ajaxToolkit:TextBoxWatermarkExtender runat="server" ID="TextBoxWatermarkExtender25" TargetControlID="tbWithdrawalNumberJournal" WatermarkCssClass="WaterText" WatermarkText="34562"></ajaxToolkit:TextBoxWatermarkExtender>
             <div><asp:TextBox runat="server" ID="tbWithdrawalNumberJournal" Width="200px"></asp:TextBox></div>
             <div style="clear:both;"></div>
         </div>
         <div class="FormItem">
             <div class="label">Фамилия:</div>
             <ajaxToolkit:TextBoxWatermarkExtender runat="server" ID="TextBoxWatermarkExtender26" TargetControlID="tbWithdrawalFirstName" WatermarkCssClass="WaterText" WatermarkText="Иванов"></ajaxToolkit:TextBoxWatermarkExtender>
             <div><asp:TextBox runat="server" ID="tbWithdrawalFirstName" Width="200px"></asp:TextBox></div>
             <div style="clear:both;"></div>
         </div>
         <div class="FormItem">
             <div class="label">Имя:</div>
             <ajaxToolkit:TextBoxWatermarkExtender runat="server" ID="TextBoxWatermarkExtender27" TargetControlID="tbWithdrawalSurname" WatermarkCssClass="WaterText" WatermarkText="Иван"></ajaxToolkit:TextBoxWatermarkExtender>
             <div><asp:TextBox runat="server" ID="tbWithdrawalSurname" Width="200px"></asp:TextBox></div>
             <div style="clear: both;"></div>
         </div>
         <div class="FormItem">
             <div class="label">Отчество:</div>
             <ajaxToolkit:TextBoxWatermarkExtender runat="server" ID="TextBoxWatermarkExtender28" TargetControlID="tbWithdrawaLastName" WatermarkCssClass="WaterText" WatermarkText="Иванович"></ajaxToolkit:TextBoxWatermarkExtender>
             <div><asp:TextBox runat="server" ID="tbWithdrawaLastName" Width="200px"></asp:TextBox></div>
             <div style="clear:both;"></div>
         </div>
         <div class="FormItem">
             <div class="label">Телефон:</div>
             <ajaxToolkit:TextBoxWatermarkExtender runat="server" ID="TextBoxWatermarkExtender29" TargetControlID="tbWithdrawalPhone" WatermarkCssClass="WaterText" WatermarkText="050-111-11-11"></ajaxToolkit:TextBoxWatermarkExtender>
             <div><asp:TextBox runat="server" ID="tbWithdrawalPhone" Width="200px"></asp:TextBox></div>
             <div style="clear:both;"></div>
         </div>
         <div class="FormItem">
                <div class="label">Адрес:</div>

                <ajaxToolkit:TextBoxWatermarkExtender runat="server" ID="TextBoxWatermarkExtender30" TargetControlID="asd" WatermarkText="Артема 942" WatermarkCssClass="WaterText"></ajaxToolkit:TextBoxWatermarkExtender>
                <div><asp:TextBox runat="server" ID="TextBox2" Width="200px" Visible="False"></asp:TextBox>
                    
                      <telerik:RadAutoCompleteBox ID="tbWithdrawalAddress" runat="server" Width="200" DropDownWidth="200"
                DropDownHeight="200" DataSourceID="SqlDataSource1" DataTextField="Name" Filter="StartsWith" InputType="Text" AllowCustomEntry="True"  Delimiter=" "
                DataValueField="Name">
                          <TextSettings SelectionMode="Single"></TextSettings>
            </telerik:RadAutoCompleteBox>
                    
                     <asp:SqlDataSource runat="server" ID="SqlDataSource3" ConnectionString="<%$ ConnectionStrings:ConnectionInfoDB4 %>"
        ProviderName="System.Data.SqlClient" SelectCommand="SELECT name FROM Streets ORDER By name asc ">
    </asp:SqlDataSource>
         ...
         <div class="FormItem">
             <asp:LinkButton runat="server" ID="WithdrawalAbonentAdd" CssClass="FormButton" OnClick="WithdrawalAbonentAdd_Click">
                 <span>Далее</span>
             </asp:LinkButton>
         </div>
         <div style="clear:both;"></div>
...
SelectCommand="" SelectCommandType="StoredProcedure" OnSelecting="dsJournal_Selecting">
	<SelectParameters>
