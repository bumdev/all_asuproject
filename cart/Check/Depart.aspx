<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="Depart.aspx.cs" Inherits="cartridges_app.Depart" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel runat="server" ID="up1">
<ContentTemplate>
<div style="width:100%; float:inherit; text-align:center;"><span style="font-weight:bold; font-size:18px; ">Справочник отделов</span></div>
<asp:TextBox runat="server" ID="tbDepartName" Width="400px"  Visible="true"></asp:TextBox>
...
<cuc:GridView  DataSourceID="dsJournal" AllowPaging="True" PageSize="50" 
	...
	<Columns>
        ...
        <asp:BoundField HeaderText="Отдел" ControlStyle-Width="400px" DataField="DepartName" SortExpression="DepartName"/>
	</Columns>
</cuc:GridView>
