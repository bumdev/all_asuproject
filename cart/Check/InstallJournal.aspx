<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" Inherits="cartridges_app.InstallJournal" Codebehind="InstallJournal.aspx.cs"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <telerik:RadAjaxManagerProxy runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="radgrid">
             ...
             <telerik:AjaxSetting AjaxControlID="InstallDet1">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="InstallDet1" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
   ...
   <script type="text/javascript">
       function RowSelected(sender, args) {
           ...
           var oWnd = radopen("InstallDeviceDet.aspx?id=" + args.getDataKeyValue("ID"), null, 800, 600, 20, 20);
           oWnd.set_visibleStatusbar = false;
           oWnd.center();

       }
    </script>
     <telerik:RadWindow runat="server" ID="radInstall" Title="Просмотр заявок"  Width="720px" MinHeight="430px" CenterIfModal="True" KeepInScreenBounds="True" VisibleStatusbar="False">
            <ContentTemplate>
    ...
    <asp:SqlDataSource ID="dsInstallJournal" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionInfo %>" 
        SelectCommand="RetrieveInstallJournal" SelectCommandType="StoredProcedure">
	<SelectParameters>  	
