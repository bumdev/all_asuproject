<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InstallDet.ascx.cs" Inherits="cartridges_app.Controls.InstallDet" %>
...
<telerik:RadAjaxPanel runat="server" ID="up">
    ...
    <asp:Panel runat="server" ID="InstallForm" Width="1500px" Height="500px">
                ...
                <asp:Panel runat="server" ID="punRequestsEditor" Visible="false">
                   ...
                   <div class="FormItem">
                        ...
                        <div>
                            ...
                            <telerik:RadButton runat="server" Text="В журнал снятия" ID="radbutbackToRemove" OnClick="radbutBackToRemove_OnClick"></telerik:RadButton>
                            <telerik:RadButton runat="server" Text="Выполнено" ID="radbutRequestsIsDone" OnClick="radbutRequestsIsDone_OnClick"></telerik:RadButton>
                        </div>
                        <div style="clear: both;"></div>
                    </div>
